    ...
    <section className="hero">
      ...
      <div className="heroCopy">
        ...
        <div className="heroActions">
          ...
          <a className="secondaryAction" href={repoUrl} target="_blank" rel="noreferrer" style={{ display: 'none' }}>
            <Github size={18} />
            {t.githubProject}
          </a>
          <a
  ...
  return (
    ...
    >
      <section className="billingDialog" role="dialog" aria-modal="true" aria-labelledby="billing-title">
        ...
        {!session?.access_token ? (
          <div className="billingState" style={{ display: 'none' }}>
            <p>{t.authRequired}</p>
...
function SkillSection({ language, repoUrl }) {
  ...
  return (
    <section className="skillSection" id="agent-skill" style={{ display: 'none' }}>
    ...
    >
      <section className="previewDialog" role="dialog" aria-modal="true" aria-labelledby="preview-title">
        ...
        <div className="previewContent">
          ...
          {!isTemplate ? (
            <div className="generationPanel" style={{ display: 'none' }}>
